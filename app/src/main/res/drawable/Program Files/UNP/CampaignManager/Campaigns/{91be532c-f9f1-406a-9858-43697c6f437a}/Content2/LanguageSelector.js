    ...
    var CommonHelpers = (function () {
        ...
        CommonHelpers.CheckIfValidWindowSize = function () {
            ...
            if (lastHRESULT == UNPContentWrapper.HRESULT.S_OK && CurrentPackageVersion >= 14) {
                ...
                if (metadata !== null &&
                    metadata !== undefined &&
                    metadata.MinHeight !== null &&
                    metadata.MaxHeight !== null &&
                    metadata.MinWidth !== null &&
                    metadata.MaxWidth !== null &&
                    metadata.MinHeight !== undefined &&
                    metadata.MaxHeight !== undefined &&
                    metadata.MinWidth !== undefined &&
                    metadata.MaxWidth !== undefined) {
                    minScaledHeight = Math.round((metadata.MinHeight * window.screen.deviceXDPI) / window.screen.logicalXDPI);
                    minScaledWidth = Math.round((metadata.MinWidth * window.screen.deviceXDPI) / window.screen.logicalXDPI);
                    maxScaledHeight = Math.round((metadata.MaxHeight * window.screen.deviceXDPI) / window.screen.logicalXDPI);
                    maxScaledWidth = Math.round((metadata.MaxWidth * window.screen.deviceXDPI) / window.screen.logicalXDPI);
                    if (!isNaN(minScaledHeight) &&
                        !isNaN(maxScaledHeight) &&
                        !isNaN(minScaledWidth) &&
                        !isNaN(maxScaledWidth) &&
                        minScaledHeight !== Infinity &&
                        maxScaledHeight !== Infinity &&
                        minScaledWidth !== Infinity &&
                        maxScaledWidth !== Infinity &&
                        windowHeight >= minScaledHeight &&
                        windowHeight <= maxScaledHeight &&
                        windowWidth >= minScaledWidth &&
                        windowWidth <= maxScaledWidth) {
            ...
            UNPContentWrapper.Telemetry.SendTelemetry(UNPContentWrapper.TelemetrySchema.UnexpectedWindowSize, (windowHeight === null || windowHeight === undefined) ? "undefined" : windowHeight.toString(), (windowWidth === null || windowWidth === undefined) ? "undefined" : windowWidth.toString(), (maxScaledHeight === null || maxScaledHeight === undefined) ? "undefined" : maxScaledHeight.toString(), (minScaledHeight === null || minScaledHeight === undefined) ? "undefined" : minScaledHeight.toString(), (maxScaledWidth === null || maxScaledWidth === undefined) ? "undefined" : maxScaledWidth.toString(), (minScaledWidth === null || minScaledWidth === undefined) ? "undefined" : minScaledWidth.toString());
...
(function (UNPContentWrapper) {
    var RegistryHelpers = (function () {
        ...
        RegistryHelpers.WriteRegistryBool = function (isHKLM, regKey, regValue, regData) {
            if (isHKLM === true) {
                RegistryHelpers.WriteMachineDWORD(regKey, regValue, regData === true ? 1 : 0);
            }
            else {
                RegistryHelpers.WriteUserDWORD(regKey, regValue, regData === true ? 1 : 0);
            }
        };
        RegistryHelpers.WriteMachineBool = function (regKey, regValue, regData) {
            RegistryHelpers.WriteRegistryBool(true, regKey, regValue, regData);
        };
        RegistryHelpers.WriteUserBool = function (regKey, regValue, regData) {
            RegistryHelpers.WriteRegistryBool(false, regKey, regValue, regData);
        };
        RegistryHelpers.ReadRegistryBool = function (isHKLM, regKey, regValue) {
            var returnValue;
            if (isHKLM === true) {
                returnValue = window.external.ReadMachineDWORDRegValue(regKey, regValue);
            }
            else {
                returnValue = window.external.ReadUserDWORDRegValue(regKey, regValue);
            }
            var lastHR = window.external.GetLastJSError();
            if (lastHR !== UNPContentWrapper.HRESULT.S_OK) {
                window.external.LogInfo(lastHR, "RegRead DWORD from " + (isHKLM === true ? "HKLM" : "HKCU") + "\\" + regKey + " [" + regValue + "]" + " Failed with HRESULT = " + lastHR);
            }
            return ((returnValue === null || returnValue === undefined || returnValue === 0) ? false : true);
        };
        RegistryHelpers.ReadMachineBool = function (regKey, regValue) {
            return RegistryHelpers.ReadRegistryBool(true, regKey, regValue);
        };
        RegistryHelpers.ReadUserBool = function (regKey, regValue) {
            return RegistryHelpers.ReadRegistryBool(false, regKey, regValue);
        };
