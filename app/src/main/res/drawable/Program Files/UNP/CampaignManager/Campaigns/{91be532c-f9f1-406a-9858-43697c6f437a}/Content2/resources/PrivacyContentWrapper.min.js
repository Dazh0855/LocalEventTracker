...
(function (UNPContentWrapper) {
    var PrivacyRegistryHelpers = (function () {
        ...
        PrivacyRegistryHelpers.UNP_REGISTRY_LAST_REMINDER_RESET_REGVAL = "LastReminderShowReset";
...
(function (UNPContentWrapper) {
    function ChooseLandingSlide() {
        UNPContentWrapper.PrivacyHelpers.ResetRemindMeLaterCountOnHighDPI();
...
(function (UNPContentWrapper) {
    var PrivacyHelpers = (function () {
        ...
        PrivacyHelpers.ResetRemindMeLaterCountOnHighDPI = function () {
            if (window.screen.deviceXDPI !== window.screen.logicalXDPI) {
                var UserRemindMeLaterReset = UNPContentWrapper.RegistryHelpers.ReadUserBool(UNPContentWrapper.RegistryHelpers.GetHKCUContentLocalStateRegistryLocation(), UNPContentWrapper.PrivacyRegistryHelpers.UNP_REGISTRY_LAST_REMINDER_RESET_REGVAL);
                if (UserRemindMeLaterReset === false) {
                    UNPContentWrapper.RegistryHelpers.WriteUserQWORD(UNPContentWrapper.RegistryHelpers.GetHKCUContentLocalStateRegistryLocation(), UNPContentWrapper.PrivacyRegistryHelpers.UNP_REGISTRY_LAST_REMINDER_SHOWN_REGVAL, 0);
                    UNPContentWrapper.RegistryHelpers.WriteUserQWORD(UNPContentWrapper.RegistryHelpers.GetHKCUContentLocalStateRegistryLocation(), UNPContentWrapper.RegistryHelpers.UNP_REGISTRY_LOCALSTATE_SESSION_REGVAL, 0);
                }
                var MachineRemindMeLaterReset = UNPContentWrapper.RegistryHelpers.ReadMachineBool(UNPContentWrapper.RegistryHelpers.GetHKLMContentLocalStateRegistryLocation(), UNPContentWrapper.PrivacyRegistryHelpers.UNP_REGISTRY_LAST_REMINDER_RESET_REGVAL);
                if (MachineRemindMeLaterReset === false) {
                    UNPContentWrapper.RegistryHelpers.WriteMachineQWORD(UNPContentWrapper.RegistryHelpers.GetHKLMContentLocalStateRegistryLocation(), UNPContentWrapper.PrivacyRegistryHelpers.UNP_REGISTRY_LAST_REMINDER_SHOWN_REGVAL, 0);
                    UNPContentWrapper.RegistryHelpers.WriteMachineQWORD(UNPContentWrapper.RegistryHelpers.GetHKLMContentLocalStateRegistryLocation(), UNPContentWrapper.RegistryHelpers.UNP_REGISTRY_LOCALSTATE_SESSION_REGVAL, 0);
                }
            }
            UNPContentWrapper.RegistryHelpers.WriteMachineBool(UNPContentWrapper.RegistryHelpers.GetHKLMContentLocalStateRegistryLocation(), UNPContentWrapper.PrivacyRegistryHelpers.UNP_REGISTRY_LAST_REMINDER_RESET_REGVAL, true);
            UNPContentWrapper.RegistryHelpers.WriteUserBool(UNPContentWrapper.RegistryHelpers.GetHKCUContentLocalStateRegistryLocation(), UNPContentWrapper.PrivacyRegistryHelpers.UNP_REGISTRY_LAST_REMINDER_RESET_REGVAL, true);
        };
