//========================================================================================
//
//  $File: //depot/indesign_13.0/gm/build/scripts/xml rules/glue code.jsx $
//
//  Owner: Lin Xia
//
//  $Author: praverma $
//
//  $DateTime: 2017/09/09 11:09:59 $
//
//  $Revision: #1 $
//
//  $Change: 997924 $
...
function __makeRuleProcessor(ruleSet, prefixMappingTable){
	...
	{
		 pathArray.push(ruleSet[ruleSetIndex].xpath);
	}
...
function __processMatchData(matchData, rProcessor)
{
	...
	while (matchData != undefined)
	{
		...
		for (var matchRulesIndex=0; matchRulesIndex<matchRules.length && applyMatchedRules && !ruleProcessor.halted; matchRulesIndex++)
		{
			applyMatchedRules = (false == ruleSet[matchRules[matchRulesIndex]].apply(element, rProcessor));
		}
